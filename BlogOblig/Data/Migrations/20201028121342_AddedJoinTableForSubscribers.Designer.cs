...
namespace BlogOblig.Data.Migrations
{
    ...
    [Migration("20201028121342_AddedJoinTableForSubscribers")]
    partial class AddedJoinTableForSubscribers
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("BlogOblig.Models.Entities.ApplicationUser", b =>
                {
            ...
            modelBuilder.Entity("BlogOblig.Models.Entities.Comment", b =>
                {
            ...
            modelBuilder.Entity("BlogOblig.Models.Entities.Post", b =>
                {
                    ...
                    b.Property<int?>("ParentBlogBlogId")
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("BlogOblig.Models.Entities.Comment", b =>
                {
                    ...
                    b.HasOne("BlogOblig.Models.Entities.Post", "ParentPost")
                        .WithMany("Comments")
            ...
            modelBuilder.Entity("BlogOblig.Models.Entities.Post", b =>
                {
                    ...
                    b.HasOne("BlogOblig.Models.Entities.Blog", "ParentBlog")
                        .WithMany("Posts")
                        .HasForeignKey("ParentBlogBlogId");
                });
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserClaim<string>", b =>
                {
                    b.HasOne("BlogOblig.Models.Entities.ApplicationUser", null)
                        .WithMany()
